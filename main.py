...
if __name__ == '__main__':
    ...
    # OCFNet optimises the coarse-to-fine transport losses of its paper, Predator the
    # circle/overlap/saliency losses
    config.desc_loss = OCFLoss(config) if config.model.__class__.__name__ == 'OCFNet' \
        else MetricLoss(config)
